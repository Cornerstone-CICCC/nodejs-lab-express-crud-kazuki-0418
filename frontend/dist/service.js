...
export const updateEmployee = async (id, firstname, lastname, age, isMarried) => {
...
export const searchEmployee = async (firstname) => {
    const res = await fetch(`http://localhost:${PORT}/employees/search?firstname=${firstname}`, {
        method: "GET",
    });
    if (!res.ok) {
